...
| File | Purpose |
|------|---------|
| `78b86cf6-c82c-41da-aa47-dea0971e4ce3.jsonl` | Session on automating Claude CLI via cron/launchd with /context command (610KB) |
| `0b072d29-b63f-420a-8083-8ca7136546a8.jsonl` | Recent session exploring metacortex structure and automation patterns (781KB) |
| `6a171918-b408-4a3e-b70d-0153ecc284c3.jsonl` | Session on codebase exploration and script development (1.0MB) |
...
None - all session files are stored at the root level.

## Search Tags

claude-code session-history metacortex project-management todo-system activity-logs jsonl transcripts conversation-archive automation expect-scripts cli-automation uuid-sessions agent-sessions lean4-work task-management
