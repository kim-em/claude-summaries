...
- [x] `Unoriented/` - Unoriented angles (unsigned) in arbitrary dimension: basic definitions via inner product, affine geometry, conformal maps, cross products, right angles, triangle inequality
