...
- [ ] `LieAdmissible/` - Lie-admissible rings and algebras where the associator satisfies an identity ensuring the commutator bracket forms a Lie ring/algebra, with instances showing pre-Lie structures are Lie-admissible (pending)
