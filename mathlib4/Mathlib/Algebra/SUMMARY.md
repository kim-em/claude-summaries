...
- [~] `NonAssoc/` - Non-associative algebras: pre-Lie rings and algebras with left or right symmetric associators, and Lie-admissible structures where associator identities ensure commutator brackets form Lie algebras (preliminary)
