...
- [ ] `Complex/` - Complex-valued special functions (pending)
- [ ] `ContinuousFunctionalCalculus/` - Continuous functional calculus for special functions (pending)
- [ ] `Elliptic/` - Elliptic functions and elliptic integrals (pending)
