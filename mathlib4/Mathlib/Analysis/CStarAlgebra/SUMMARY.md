...
- [ ] `ContinuousFunctionalCalculus/` - Continuous functional calculus for C⋆-algebras (applying continuous functions to operators); includes basic theory, instances, integral formulation, isometric properties, order properties, restrictions, uniqueness, and separate unital/non-unital treatments (pending)
