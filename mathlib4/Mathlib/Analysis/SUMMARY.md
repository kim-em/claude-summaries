...
- [~] `BoxIntegral/` - Box integrals (Henstock-Kurzweil integration theory) (preliminary)
- [ ] `CStarAlgebra/` - C*-algebras (Banach *-algebras with C* identity) and their analysis (pending)
