...
- [~] `Control/` - Functional programming abstractions: functors, applicatives, monads, monad transformers (StateT/ReaderT/ExceptT), bifunctors, traversable structures, folding operations, random generation, fixed-point operators, universe lifting (preliminary)
