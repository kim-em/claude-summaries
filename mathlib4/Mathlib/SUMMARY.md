...
- [~] `Algebra/` - Algebraic structures and theory (groups, rings, fields, modules, algebras) (preliminary)
- [ ] `AlgebraicGeometry/` - Algebraic geometry foundations (schemes, morphisms, sheaves) (pending)
- [ ] `AlgebraicTopology/` - Algebraic topology (simplicial sets, homology, fundamental groups) (pending)
