...
- [ ] `Atoms/` - Atomic and coatomic structures
- [ ] `BooleanAlgebra/` - Boolean algebra hierarchy
- [ ] `BoundedOrder/` - Bounded orders with top and bottom
- [ ] `Bounds/` - Bounds, suprema, and infima
