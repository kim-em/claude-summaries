...
- [ ] `Embedding/` - Embeddings between types (injective functions with additional structure)
- [ ] `Encodable/` - Encodable types (countably infinite or finite types with encode/decode to ℕ)
