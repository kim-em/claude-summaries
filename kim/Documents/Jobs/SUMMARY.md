---
source_path: /Users/kim/Documents/Jobs
generated: 2025-12-02T07:15:00Z
...
Employment and job-related materials organized by institution and employer, spanning academic positions (UC Berkeley PhD/teaching 2001-2012, Miller Fellowship, ANU faculty 2012-present), industry consulting (Microsoft Research, Harmonic/Concordance), and grant applications (Australian Research Council Discovery Projects and Future Fellowship). Contains extensive teaching materials from Berkeley GSI positions, annual ANU administrative records, detailed grant application histories with forecasts and reports, and contractor agreements with invoices. Also includes small reference files for visa applications (countries list for ASD) and university system credentials.

## Key Files

No files are stored directly in the Jobs root directory (only subdirectories).
...
employment jobs academic-positions teaching berkeley-gsi miller-fellowship anu-faculty microsoft-research harmonic-consulting lean-fro grant-applications arc-discovery-project future-fellowship phd-supervision teaching-materials invoices contractor-agreements timesheets kim-morrison
