...
- [~] `Jones/` - Reference letters for Corey Jones - 3 exceptionally strong recommendations from distinguished mathematicians (Bisch, Vaes, Vaughan Jones) for PhD candidate at Vanderbilt specializing in tensor categories, planar algebras, subfactors, quantum groups, and representation theory of rigid C*-tensor categories (preliminary)
