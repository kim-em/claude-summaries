...
| File | Purpose |
|------|---------|
| `MATH1014-LinearAlgebra-Lecture05.tex` | Main LaTeX source (16KB, 571 lines) defining vector spaces via 10 axioms, proving M₂ₓ₂, P₂, Pₙ, functions ℱ, and ℝ₊ (with exotic ⊕/⊗ operations) are vector spaces, introducing subspaces (3 axioms: contains 0, closed under addition/scalar mult), proving span(S) is a subspace, with 15+ worked examples including symmetric matrices, first quadrant (counterexample), polynomials vanishing at t=1 |
| `MATH1014-LinearAlgebra-Lecture05.pdf` | Compiled beamer presentation (274KB, generated from .tex source) |
...
vector-spaces abstract-algebra subspaces span axioms M2x2-matrices polynomials Pn function-spaces closure zero-vector geometric-interpretation beamer-slides linear-algebra math1014 anu 2015 lay-textbook
