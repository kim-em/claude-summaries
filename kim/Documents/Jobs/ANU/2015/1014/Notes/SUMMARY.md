...
- [~] `Lecture23/` - Twenty-third lecture on the Least Squares Problem (finding best approximations to inconsistent linear systems via normal equations A^TA x̂ = A^T b) (preliminary)
