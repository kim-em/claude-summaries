...
| File | Purpose |
|------|---------|
| `MATH1014-LinearAlgebra-Lecture03.tex` | LaTeX beamer source covering lines in ℝ² and ℝ³ (vector/parametric/symmetric forms), planes in ℝ³ (vector/scalar equations), warm-up on orthogonality, examples of line intersections, plane from three points, and finding intersection lines between planes (14.7KB, 529 lines) |
| `MATH1014-LinearAlgebra-Lecture03.pdf` | Compiled PDF output of lecture slides (270KB) |
...
math1014 linear-algebra lecture-03 lines planes vectors parametric-equations symmetric-equations normal-vectors cross-product euclidean-geometry anu 2015 beamer latex scott-morrison
