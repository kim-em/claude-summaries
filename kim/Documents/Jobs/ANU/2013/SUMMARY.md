...
| File | Purpose |
|------|---------|
| annual-report-2013.txt | Annual report documenting teaching (MATH3325 Analysis 3, 13 students), supervision (Joshua Chen honours, Sebastian Mueller, Narjess Afzaly), extensive travel (Vietnam, USA, Australia), research collaborations, grants (DECRA $125k, DARPA $228k, Sloan $4k), MathOverflow moderation, media coverage |
| MathsDay.tex | LaTeX source for Maths Day competition problem set with 10 mathematical problems and answer key |
| MathsDay.pdf | Compiled PDF of Maths Day competition problems covering work rate, ratios, probability, geometry, Fibonacci sequences, combinatorics, and number theory |
...
anu 2013 annual-report decra-fellowship analysis3 math3325 teaching khovanov-homology subfactors tqft research-travel bodega-bay maui vietnam quantum-topology fusion-categories planar-algebras vaughan-jones emily-peters noah-snyder masaki-izumi kevin-walker david-penneys microsoft-station-q mathoverflow outreach maths-day competition joshua-chen honours-supervision austms representation-theory category-theory grants darpa sloan media quanta-magazine new-scientist functional-analysis
