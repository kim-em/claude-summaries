...
- [ ] `Assignments/` - Four assignments with TeX source, compiled PDFs, sample solutions (Assignments 1, 2, 4), student submission folders, essay components (EssayTopics, EssayDrafts, EssayExamples, FinalEssays) (pending)
