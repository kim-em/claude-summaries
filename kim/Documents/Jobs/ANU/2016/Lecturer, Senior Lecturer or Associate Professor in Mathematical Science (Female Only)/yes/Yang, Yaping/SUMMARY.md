...
| File | Purpose |
|------|---------|
| application.pdf | Complete ANU job application form with candidate information, referee details, and uploaded documents (6.7 MB) |
| Yaping Yang_Reference Report by Ivan Mirkovic.pdf | Reference letter from current supervisor at UMass Amherst |
| Yaping Yang_Reference Report by Marc N Levine.pdf | Reference letter from Marc Levine (Universität Duisburg-Essen), collaborator on elliptic cohomology work |
| Yaping Yang_Reference Report by Pavel Etingof.pdf | Reference letter from Pavel Etingof (MIT) |
| Yaping Yang_Reference Report by Valerio Toledano Laredo.pdf | Reference letter from PhD advisor at Northeastern University |
...
yaping-yang geometric-representation-theory quantum-groups yangian elliptic-quantum-groups cohomological-hall-algebra nakajima-quiver-varieties integrable-systems kzb-equations deformed-double-current-algebras morava-k-theory elliptic-cohomology umass-amherst northeastern-university valerio-toledano-laredo ivan-mirkovic pavel-etingof marc-levine phd-2014 anu-application-2016
