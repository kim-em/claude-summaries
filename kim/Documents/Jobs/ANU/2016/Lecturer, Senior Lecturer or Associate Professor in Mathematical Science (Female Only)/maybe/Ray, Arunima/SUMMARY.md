...
| File | Purpose |
|------|---------|
| application.pdf | Complete application package including cover letter, CV, selection criteria, research statement (13 pages on knot concordance/satellite operators), and teaching statement |
| Arunima Ray_Reference Report by Jae Choon Cha.pdf | Reference letter from Prof. Jae Choon Cha (POSTECH, South Korea) |
| Arunima Ray_Reference Report by Rebecca Torrey.pdf | Reference letter from Prof. Rebecca Torrey (Brandeis University) - teaching reference |
| Arunima Ray_Reference Report by Shelly Harvey.pdf | Reference letter from Prof. Shelly Harvey (Rice University) - PhD advisor's colleague |
...
anu faculty-search 2016 maybe-candidate arunima-ray low-dimensional-topology knot-theory knot-concordance 4-manifolds satellite-operators brandeis-university rice-university tim-cochran postdoc topology algebraic-geometric-topology casson-towers slice-knots topologically-slice reference-letters application-materials joan-licata
