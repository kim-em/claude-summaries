...
| File | Purpose |
|------|---------|
| application.pdf | Main application with CV, selection criteria responses, research vision, teaching philosophy, and cover letter (18 pages) |
| RamaduraiReference-Greenhill-ANU.pdf | Reference letter from Catherine Greenhill (UNSW), former postdoc supervisor, on Hamilton cycles research |
| letter_for_ramadurai.pdf | Reference letter from Andrzej Dudek (Western Michigan), PhD supervisor, on Ramsey theory work |
| Reshma16.pdf | Reference letter from Tim Stokes (Waikato) on teaching abilities |
| Reshma16Scan.pdf | Scanned version of Tim Stokes reference letter (duplicate) |
| SKMBT_b423016090714511.pdf | Reference letter from Nick Cavenagh (Waikato dept chair) on research collaboration and teaching |
