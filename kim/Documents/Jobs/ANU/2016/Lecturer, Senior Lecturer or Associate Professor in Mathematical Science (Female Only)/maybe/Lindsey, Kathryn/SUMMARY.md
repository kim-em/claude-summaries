...
| File | Purpose |
|------|---------|
| application.pdf | Complete ANU application package containing: cover letter, CV (10 publications including work with W. Thurston and L. DeMarco), teaching statement (classroom and tall ship maritime teaching experience), and research statement describing work on Julia set shapes and flat surface dynamics |
