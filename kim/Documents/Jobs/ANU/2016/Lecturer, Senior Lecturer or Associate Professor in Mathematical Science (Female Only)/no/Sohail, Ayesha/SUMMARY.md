...
| File | Purpose |
|------|---------|
| application.pdf | 14-page ANU application form with candidate information, 4 referee details (Prof. Anila Asif at COMSATS Lahore, Prof. Abdul Siddiqui at Penn State, Dr. Khadija Maqbool in Pakistan, Prof. Farid Chighoub at Biskra University Algeria), and complete CV showing PhD from Sheffield 2008-2012, research in surface waves/ODEs/PDEs, awards including $20k research productivity award, extensive teaching at COMSATS, programming skills (MATLAB, COMSOL, Maple, Mathematica, C++, SPSS), 30+ journal publications, and covering letter addressing selection criteria |
...
anu faculty-search ayesha-sohail 2016 rejected-application pakistan applied-mathematics computational-mathematics sheffield-university comsats numerical-analysis mathematical-biology fractional-calculus tumor-modeling capillary-gravity-waves no-work-rights
