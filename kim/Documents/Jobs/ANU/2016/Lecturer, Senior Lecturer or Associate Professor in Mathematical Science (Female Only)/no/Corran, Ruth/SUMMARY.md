...
| File | Purpose |
|------|---------|
| application.pdf | Complete 22-page application form with referee information, uploaded documents, and candidate responses |
| Ruth Corran_Reference Report by Claudio Piani.pdf | Reference letter from Prof. Claudio Piani (American University of Paris colleague) |
| Ruth Corran_Reference Report by David Easdown.pdf | Reference letter from Dr. David Easdown (University of Sydney, PhD supervisor and current collaborator) |
| Ruth Corran_Reference Report by Jean Michel.pdf | Reference letter from Prof. Jean Michel (CNRS, Paris, research collaborator) |
| Ruth Corran_Reference Report by Michel Broue.pdf | Reference letter from Prof. Michel Broué (Paris 7, research collaborator) |
...
ruth-corran anu-application 2016 female-only-position mathematical-sciences algebra braid-groups reflection-groups garside-structures american-university-paris associate-professor international-mathematician sydney australia france teaching-research-balance family-relocation senior-lecturer dual-citizenship reference-letters research-publications cv cover-letter
